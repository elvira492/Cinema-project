  ...
  return (
    <Carousel className="shadow-xl">
      <div className="height1 flex items-center justify-center bg-red-200">
        <img
          src="/static/images/view-3d-cinema-theatre-room.jpg"
      ...
      <div className="height1 flex items-center justify-center">
        <img
          src="/static/images/people-cinema-watching-movie.jpg"
      ...
      <div className="height1 flex items-center justify-center">
        <img
          src="/static/images/portrait-young-little-boy.jpg"
      ...
      <div className="height1 flex items-center justify-center">
        <img
          src="/static/images/3d-senior-man-watching-movie-cinema-with-popcorn.jpg"
          className="object-contain max-h-screen w-full"
          alt="Bild 4"
        />
      </div>
      <div className="height1 flex items-center justify-center">
        <img
          src="/static/images/3d-rendering-person-watching-movie-with-popcorn.jpg"
          className="object-contain max-h-screen w-full"
          alt="Bild 5"
        />
      </div>
